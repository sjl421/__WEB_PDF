...
public class PrintlnClass {
    ...
    private static void printlnFileDownloadLink() throws IOException {
        String uri = "https://github.com/dzet-share/__WEB_PDF";

        uri = uri.concat("/tree/master/file");
...
//            System.out.println(html);
            ...
            Elements contentTds = document.select("#js-repo-pjax-container > div.container.new-discussion-timeline.experiment-repo-nav > div.repository-content > div.file-wrap > table > tbody:eq(1) > tr:gt(2) > td:eq(1) > span > a");
